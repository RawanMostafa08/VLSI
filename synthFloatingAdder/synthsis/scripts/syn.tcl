...
set design FloatingAdder_Integration
...
analyze -library work -format  verilog {../rtl/PlusOperatorAdder.v ../rtl/FloatingPointAdder.v ../rtl/FloatingAdder_Integration.v }
